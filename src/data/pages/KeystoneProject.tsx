...
const keystoneData: ProjectData = {
  ...
  highlights: [
    "Légèreté radicale grâce à Tauri (Rust) au lieu d'Electron : autour de 5 Mo de RAM en fonctionnement, contre environ 200 Mo pour le runtime Overwolf seul (sur lequel s'appuient Outplayed et Porofessor) et jusqu'à 500 Mo pour DPM. Côté processeur, l'app reste sous les 2%, là où DPM peut grimper jusqu'à 20% d'un bon CPU. Elle reste invisible quand on joue, et cette légèreté laisse les ressources à la partie, y compris sur une configuration modeste.",
